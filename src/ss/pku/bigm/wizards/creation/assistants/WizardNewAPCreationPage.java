package ss.pku.bigm.wizards.creation.assistants;
...
public class WizardNewAPCreationPage extends WizardPage {
	...
	public WizardNewAPCreationPage(
	...
	public String getFileName() {
		...
		return (!s.endsWith(".bigraph-ap") ? s + ".bigraph-ap" : s);
	}
