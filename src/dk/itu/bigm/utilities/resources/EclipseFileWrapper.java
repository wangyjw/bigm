...
public class EclipseFileWrapper extends EclipseResourceWrapper
	...
	public ModelObject load() throws LoadFailedException {
		try {
			//!TODO Kevin Chan Load Bigraph AP
//			System.out.println(getResource());
//			System.out.println(getResource().getContentDescription());
//			System.out.println(getResource().getContentDescription().getContentType());
