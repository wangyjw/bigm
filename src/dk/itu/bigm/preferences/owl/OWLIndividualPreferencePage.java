...
public class OWLIndividualPreferencePage
	...
	public OWLIndividualPreferencePage() {
		setPreferenceStore(BigMPlugin.getInstance().getPreferenceStore());
		setDescription("Built-in configuration for OWL Individuals");
	}
		
	@Override
	protected Control createContents(Composite parent) {
		keyTable = new Table(parent, SWT.MULTI|SWT.BORDER|SWT.FULL_SELECTION | SWT.CHECK);
		CommonFuncUtilities.drawTableWithCheck(parent, keyTable, LinkSortKey.keysForOWLInd, keySetInd);
		
		CommonFuncUtilities.copyHashMapToHashMap(keySetInd, beforeAction);
