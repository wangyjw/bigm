...
public class XMLPrimitivePreferencePage
	...
	public XMLPrimitivePreferencePage() {
	...
	protected Control createContents(Composite parent) {
		...
		CommonFuncUtilities.drawTableWithCheck(parent, keyTable, LinkSortKey.keysForXMLPri, keySetPri);
		
		CommonFuncUtilities.copyHashMapToHashMap(keySetPri, beforeAction);
