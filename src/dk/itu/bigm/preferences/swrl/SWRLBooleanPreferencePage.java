...
public class SWRLBooleanPreferencePage
	...
	public SWRLBooleanPreferencePage() {
		setPreferenceStore(BigMPlugin.getInstance().getPreferenceStore());
		setDescription("Built-in configuration for SWRL Booleans");
	}
		
	@Override
	protected Control createContents(Composite parent) {
		keyTable = new Table(parent, SWT.MULTI|SWT.BORDER|SWT.FULL_SELECTION | SWT.CHECK);
		CommonFuncUtilities.drawTableWithCheck(parent, keyTable, LinkSortKey.keysForSWRLBool, keySetBool);
		
		CommonFuncUtilities.copyHashMapToHashMap(keySetBool, beforeAction);
