...
public class SWRLComparisonPreferencePage
	...
	public SWRLComparisonPreferencePage() {
		setPreferenceStore(BigMPlugin.getInstance().getPreferenceStore());
		setDescription("Built-in configuration for SWRL Comparisons");
	}
		
	@Override
	protected Control createContents(Composite parent) {
		keyTable = new Table(parent, SWT.MULTI|SWT.BORDER|SWT.FULL_SELECTION | SWT.CHECK);
		CommonFuncUtilities.drawTableWithCheck(parent, keyTable, LinkSortKey.keysForSWRLCmp, keySetCmp);
		
		CommonFuncUtilities.copyHashMapToHashMap(keySetCmp, beforeAction);
