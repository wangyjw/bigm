...
public class SWRLListPreferencePage
	...
	public SWRLListPreferencePage() {
		setPreferenceStore(BigMPlugin.getInstance().getPreferenceStore());
		setDescription("Built-in configuration for SWRL Lists");
	}
		
	@Override
	protected Control createContents(Composite parent) {
		keyTable = new Table(parent, SWT.MULTI|SWT.BORDER|SWT.FULL_SELECTION | SWT.CHECK);
		CommonFuncUtilities.drawTableWithCheck(parent, keyTable, LinkSortKey.keysForSWRLList, keySetList);
		
		CommonFuncUtilities.copyHashMapToHashMap(keySetList, beforeAction);
