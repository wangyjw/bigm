...
public abstract class ExtendedDataUtilities {
	 ...
	 * @author Kevin Chan 
	 */
	public static final String PORTINDEX =
			"eD!+dk.itu.bigm.model.portIndex";
	
	public static int getPortIndex(Port n) {
		return getPortIndex(null, n);
	}
	
	public static int getPortIndex(PropertyScratchpad context, Port n) {
		return n.getIndex();
	}
	// ends
	...
	//!TODO 增加属性值
	@BigmProperty(fired = String.class, retrieved = String.class)
	public static final String NODEVALUE =
	"eD!+dk.itu.bigm.model.ModelObject.nodeValue";
		
	public static String getNodeValue(ModelObject m) {
		return getNodeValue(null, m);
	}	
	
	public static String getNodeValue(
			PropertyScratchpad context, ModelObject m) {
		return getProperty(context, m, NODEVALUE, String.class);
	}
	
	public static void setNodeValue(ModelObject m, String s) {
		m.setExtendedData(NODEVALUE, s);
	}
	
	public static IChange changeNodeValue(ModelObject m, String s) {
		return m.changeExtendedData(NODEVALUE, s, null, commentNormaliser);
	}
	
	public static IChangeDescriptor changeNodeValueDescriptor(
			ModelObject.Identifier l, String oldValue, String newValue) {
		return new ModelObject.ChangeExtendedDataDescriptor(
				l, NODEVALUE, oldValue, newValue, null, commentNormaliser);
	}
	//!TODO 新属性值
}
