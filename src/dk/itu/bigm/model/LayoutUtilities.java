...
public abstract class LayoutUtilities {
	...
	@BigmProperty(fired = Rectangle.class, retrieved = Rectangle.class)
	public static final String LAYOUT =
			"eD!+dk.itu.bigm.Layoutable.layout";
...
//							System.out.println(l.toString(context) + " overlaps with " + i.toString(context));
//							throw new ChangeRejectedException(c,
...
//									i.toString(context));
			...
			if (!(parent instanceof Bigraph)) {
				...
				/**
				 * 处理 inner name 和 outer name 的位置问题
				 */
