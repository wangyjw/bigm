...
import org.bigraph.model.Link.ChangeLinkSort;
...
abstract class DescriptorUtilities {
	...
	static IChangeDescriptor createDescriptor(
		...
		} else if (c instanceof ChangeLinkSort) {
			ChangeLinkSort ch = (ChangeLinkSort)c;
			chd = new ChangeLinkSortDescriptor(
					ch.getCreator().getIdentifier(context),
					ch.getCreator().getLinkSort(context));
