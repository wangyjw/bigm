...
import dk.itu.bigm.editors.bigraph.commands.LayoutableCreateCommand;
import dk.itu.bigm.editors.bigraph.commands.LayoutableMoveCommand;
import dk.itu.bigm.editors.bigraph.commands.LayoutableReparentCommand;
...
public class LayoutableLayoutPolicy extends XYLayoutEditPolicy {
	...
	protected EditPolicy createChildEditPolicy(EditPart child) {
		return new BigMResizableEditPolicy();
	}
